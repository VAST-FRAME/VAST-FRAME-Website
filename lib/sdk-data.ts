...
export const sdkProducts: readonly SdkProduct[] = [
  {
    ...
    media: [
      ...
      { slot: "THRESHOLD_AREA_LIGHT_VOLUME", ratio: "4 / 5", tone: "pink", title: "Area light volume study", direction: "Vertical interior composition with several shaped emitters, visible penumbra variation, and glossy response.", size: "portrait" },
      ...
      { slot: "THRESHOLD_RECONSTRUCTION_COMPARISON", ratio: "21 / 9", tone: "pink", title: "Reconstruction paths, matched frame", direction: "Three-panel crop prepared for native, DLSS/FSR, and STP comparison at identical camera and exposure.", size: "wide" },
    ],
  },
  {
    index: "02",
    ...
    media: [
      { slot: "ATRIUM_ATMOSPHERE_HERO", ratio: "21 / 9", tone: "pink", title: "Atmosphere from ground to orbit", direction: "Extreme-wide horizon with layered aerial perspective, a low sun, cloud silhouettes, and visible celestial depth.", size: "wide" },
      ...
      { slot: "ATRIUM_AURORA_WEATHER_EVENT", ratio: "1 / 1", tone: "pink", title: "Aurora as a world event", direction: "Square environmental frame pairing aurora curtains with reflective terrain and readable atmospheric falloff.", size: "square" },
  ...
  },
  {
    ...
    media: [
      ...
      { slot: "ECLIPSE_UV_PACKING_INSPECTION", ratio: "1 / 1", tone: "pink", title: "UV packing inspection", direction: "Dense but legible atlas with utilization, padding, and problem-island callouts.", size: "square" },
      ...
      { slot: "ECLIPSE_STREAMING_REGION_MAP", ratio: "21 / 8", tone: "pink", title: "Area streaming at world scale", direction: "Long-form topographic view of loaded, warming, and dormant regions around a player path.", size: "wide" },
    ],
  },
  {
    index: "04",
    ...
    media: [
      ...
      { slot: "CAUSALITY_ELECTRIC_ARC_NETWORK", ratio: "4 / 5", tone: "pink", title: "Electric arc network", direction: "Vertical machinery stack with branching conductive paths, contact points, and energy falloff.", size: "portrait" },
      ...
      { slot: "CAUSALITY_NPC_SYSTEMIC_RESPONSE", ratio: "16 / 10", tone: "pink", title: "NPC response to a changing world", direction: "Gameplay-width composition of perception, avoidance, and interaction triggered by the same simulated event.", size: "half" },
